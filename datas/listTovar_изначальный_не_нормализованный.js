...
goods.models = [{
    c6_1: {
        ...
        description: "Столовые приборы серии Тройка изготовлены из нержавеющей стали, толщиной 2,5 мм. Цвет всей ложки однородный металик(серебристый глянцевый).</p> <p>Изготавливаются данные столовые приборы в России на Павловском заводе художественных металлоизделий. Изделия имеют высокое качество и имеют сертификат соответствия.</p> <p>Мы наносим на данные изделия любые гравировки, будь то надписи, логотипы, узоры и даже фотографии.",
        photos: {
            all: ['images/tovar/lojki/troika/0.jpg', 'images/tovar/lojki/troika/1.jpg', 'images/tovar/lojki/troika/2.jpg', 'images/tovar/lojki/troika/3.jpg']
        }
    },
    c6_2: {
        cat_name: 'Серия',
        ...
        description: "Тройка с позолотой ручки или коротко Тройка с ЛНТП(локальным нитрид титановым покрытием) - наиболее известная в линейке столовых приборов Павловского завода.</p> <p>Имеет такие же характеристики что и простая Тройка. Но к тому же декоративные ручки столовых приборов выполнены методом штампованной чеканки, что говорит об уникальности производства. </p><p>Рабочие части имеют классические размеры и формы.",
        photos: {
            all: ['images/tovar/lojki/troika_s_pozolot/0.jpg', 'images/tovar/lojki/troika_s_pozolot/1.jpg', 'images/tovar/lojki/troika_s_pozolot/2.jpg', 'images/tovar/lojki/troika_s_pozolot/3.jpg']
        }
    },
    c6_3: {
        cat_name: 'Серия',
        ...
        description: "Торжество с позолотой(нитрид титановым покрытием) это столовые приборы с простым и элегантным дизайном. <p/><p>Зеркальный блеск изделиям придан с помощью самой современной электроимпульсной полировки столовых приборов (ЭИП).</p><p> На рабочие части предметов нанесено нитрид титановое покрытие под золото.",
        photos: {
            all: ['images/tovar/lojki/torjestvo_s_pozolotoi/0.jpg', 'images/tovar/lojki/torjestvo_s_pozolotoi/1.jpg', 'images/tovar/lojki/torjestvo_s_pozolotoi/2.jpg', 'images/tovar/lojki/torjestvo_s_pozolotoi/3.jpg']
        }
    },
    c6_4: {
        cat_name: 'Серия',
        ...
        photos: {
            all: ['images/tovar/lojki/slavianka/0.jpg', 'images/tovar/lojki/slavianka/1.jpg', 'images/tovar/lojki/slavianka/2.jpg', 'images/tovar/lojki/slavianka/3.jpg']
        }
    },
    c6_5: {
        cat_name: 'Серия',
        ...
        photos: {
            all: ['images/tovar/lojki/troika_plus/0.jpg', 'images/tovar/lojki/troika_plus/1.jpg', 'images/tovar/lojki/troika_plus/2.jpg', 'images/tovar/lojki/troika_plus/3.jpg']
        }
    },
    c6_6: {
        cat_name: 'Серия',
        ...
        photos: {
            all: ['images/tovar/lojki/uralocka_lntp/0.jpg', 'images/tovar/lojki/uralocka_lntp/1.jpg', 'images/tovar/lojki/uralocka_lntp/2.jpg', 'images/tovar/lojki/uralocka_lntp/3.jpg']
        }
    },
    c1_1: {
        cat_name: 'Power Bank ',
        ...
        photos: {
            all: ['images/tovar/other/akb/0.jpg', 'images/tovar/other/akb/1.jpg', 'images/tovar/other/akb/2.jpg']
        }
    },
    c1_2: {
        cat_name: 'Визитницы ',
        ...
        description: "",
        photos: {
            all: ['images/tovar/other/vizitica/0.jpg', 'images/tovar/other/vizitica/1.jpg', 'images/tovar/other/vizitica/2.jpg']
        }
    },
    c1_3: {
        ...
        photos: {
            all: ['images/tovar/other/zamki/0.jpg', 'images/tovar/other/zamki/1.jpg', 'images/tovar/other/zamki/2.jpg']
        }
    },
    c1_4: {
        ...
        photos: {
            all: ['images/tovar/other/breloki_zerkala/0.jpg', 'images/tovar/other/breloki_zerkala/1.jpg', 'images/tovar/other/breloki_zerkala/2.jpg']
        }
    },
    c1_5: {
        ...
        photos: {
            all: ['images/tovar/other/fliaga_zazig/0.jpg', 'images/tovar/other/fliaga_zazig/1.jpg', 'images/tovar/other/fliaga_zazig/2.jpg', 'images/tovar/other/fliaga_zazig/3.jpg']
        }
    }
}]
