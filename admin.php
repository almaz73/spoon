    ...
    if ($_COOKIE['PrivatePageLogin'] == md5($password . $nonsense)) {
      ...
      <section id="catalog">
        ...
        <div style="color: white; text-align: center">
          <br>
          <h4>Внимание</h4>
          <p><b>Осторожно!</b> Удаленные рисунки удаляются из хранилища. В случае, восстановления необходимо по новой загрузить рисунок.</p>
          <p>Редактируемые поля в карточке товара: серия, название, фотография, описание.</p>
          <p>Возможность скрытия условий скидочной системы.</p>
          <p>Баннеры меняются, без возможности добавления новых.
            Допустимое название файлов для банера: 01.jpg, 02.jpg, 03.jpg, 04.jpg.</p>
          <p>Баннеры могут быть разных размеров, но в пропорции 1200:485 (ширина к высоте)</p>
          <p>Фотографии могут быть любых размеров, но в пропорции около 1350∶880 (ширина к высоте)</p>
          <p>Фотки для удобства желательно иметь осмысленные (привязанные а табличке) имена</p>
        </div>
      </section>
